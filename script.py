...
def infer(url):
	...
	mnb_score = mnb_clf.predict_proba(X_tfidf)[0]
	ada_score = ada_clf.predict_proba(X_tfidf)[0]
	svm_clf = svm_clf.predict_proba(X_tfidf)[0]
...
# infer("http://www.theonion.com/graphic/sean-spicer-cradling-comfort-pig-throughout-briefi-56317")
	# learn("dataset/politifact_output-cleaned.csv")
